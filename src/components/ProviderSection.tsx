      ...
      <Card
        sx={{
          ...
          '&::before': {
            ...
            right: 0,
            height: 4,
            background: `linear-gradient(90deg, ${providerInfo.color}, ${providerInfo.color}cc)`,
          },
        }}
      >
        <CardContent sx={{ p: 4 }}>
          ...
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            <Box
              sx={{
                ...
                margin: '0 auto 16px',
                background: `linear-gradient(135deg, ${providerInfo.color}20 0%, ${providerInfo.color}30 100%)`,
